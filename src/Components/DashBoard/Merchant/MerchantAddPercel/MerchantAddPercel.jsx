...
const incrementCnNumber = (cnNumber) => {
  ...
  const onSubmit = async (data) => {
    ...
    const PercelInformation = {
      ...
      Cod_Perchent: parseFloat(verifiedUser?.subDistrictCharge) || 0,
        ...
        <p className="text-red-800 mt-1"> Returned: {Returned}</p>
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className={`input input-bordered w-full p-2 rounded-lg border ${errors.customerName ? 'border-red-500' : 'border-gray-300'
                        }`}
                  ...
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      className={`input input-bordered w-full p-2 rounded-lg border ${errors.customerAddress ? 'border-red-500' : 'border-gray-300'
                        }`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="col-span-2 md:col-span-2 lg:col-span-1">
                    ...
                    <select
                      ...
                      className={`select select-bordered w-full p-2 rounded-lg border ${errors.store ? 'border-red-500' : 'border-gray-300'
                        }`}
      ...
      {shop?.Store_Name}
                  ...
                  <div className="col-span-2 md:col-span-2 lg:col-span-1">
                    ...
                    <input
                      ...
                      className={`input input-bordered w-full p-2 rounded-lg border ${errors.orderId ? 'border-red-500' : 'border-gray-300'
                        }`}
                  ...
                  <div className="col-span-2 md:col-span-2 lg:col-span-1">
                    ...
                    <select
                      ...
                      className={`select select-bordered w-full p-2 rounded-lg border ${errors.weightPackage ? 'border-red-500' : 'border-gray-300'
                        }`}
                  ...
                  <div className="col-span-2 md:col-span-2 lg:col-span-1">
                    ...
                    <input
                      ...
                      className={`input input-bordered w-full p-2 rounded-lg border ${errors.totalAmount ? 'border-red-500' : 'border-gray-300'
                        }`}
                  ...
                  <div className="col-span-2 md:col-span-2 lg:col-span-1">
                    ...
                    <select
                      ...
                      className={`select select-bordered w-full p-2 rounded-lg border ${errors.serviceType ? 'border-red-500' : 'border-gray-300'
                        }`}
          ...
          <option value="Office_Delivery">Office Delivery</option>
            ...
            <div className="bg-gray-100 p-4 sm:p-6 md:p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-2 md:space-y-4">
                ...
                {/* <div className="flex justify-between">
              <span className="text-gray-700">CN Number</span>
              <span className="text-gray-500">{MerchantCnNumber || "Not Confirm"} </span>
            </div> */}
                <div className="flex justify-between">
