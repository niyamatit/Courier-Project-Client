    ...
    <div className="flex flex-col w-full max-w-2xl p-10 rounded-lg bg-white shadow-2xl text-gray-900">
      ...
      <form onSubmit={handleSubmit(handleSignUp)} className="space-y-6">
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="customerAddress" className="block mb-2 text-sm font-medium text-gray-700">Your Address*</label>
            <input
              type="text"
              id="customerAddress"
              ...
              className="w-full px-4 py-3 border rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 bg-gray-100"
            />
            {errors.customerAddress && <span className="text-red-500">This field is required</span>}
          </div>

          {/* Flexbox Grid for Districts and Area */}
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block mb-2 text-sm font-medium text-gray-700">Districts*</label>
              <select
        ...
        <div>
          <button
            type="submit"
            className="w-full py-3 text-white bg-blue-600 rounded-lg shadow-lg hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 transition duration-200"
          >
      ...
      <p className="px-6 text-sm text-center text-gray-500 mt-6">
        ...
        <Link to="/merchantLogin" className="text-blue-600 hover:underline">
          Login
        </Link>.
      </p>
    </div>
